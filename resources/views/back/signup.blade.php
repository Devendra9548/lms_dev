    ...
    <div class="auth-box auth-box-signup">
        ...
        <form action="{{route('signing')}}" method="POST" autocomplete="off">
            ...
            <div class="my-3">
                ...
                <p class="text-bold"><i>Enter your OTP*</i></p>
            </div>
            @else
            <div class="my-3">
                <label>Full Name</label>
                <input type="text" class="form-control" value="{{ old('uname') }}" placeholder="Enter Full Name"
            ...
            <div class="my-3">
                <label>Email</label>
                <input type="email" class="form-control" value="{{ old('uemail') }}" placeholder="Enter your email"
            ...
            <div class="my-3">
                ...
                <input type="tel" id="phone" class="form-control d-block" value="{{ old('uphone') }}" name="uphone"
                    autocomplete="off">
